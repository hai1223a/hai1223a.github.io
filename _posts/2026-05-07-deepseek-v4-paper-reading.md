...
<p class="image-caption">图 1：DeepSeek-V4 性能测试比较</p>
...
<p class="image-caption">图 2：CSA（Compressed Sparse Attention）流程图</p>
...
<p class="image-caption">图 3：HCA（Heavily Compressed Attention）流程图</p>
...
<p class="image-caption">图 4：Hyper-Connections 流程图</p>
...
<p class="image-caption">图 5：mHC（Manifold-Constrained Hyper-Connections）流程图</p>
...
<p class="image-caption">图 6：state cache 与 KV cache 组织图</p>
